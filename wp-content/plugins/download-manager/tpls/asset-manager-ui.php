        ...
        <div class="panel-body">
            <div class="media well-sm well-file" style="margin: 0;padding: 0">
                <div class="pull-right">
                    ...
                    <button class="btn btn-simple btn-sm ttip" title="Full Screen"  onclick="document.getElementById('mainfmarea').requestFullscreen();"><i class="fa fa-expand-arrows-alt"></i></button>
                </div>
