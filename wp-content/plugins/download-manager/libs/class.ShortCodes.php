...
class ShortCodes
{
    ...
    function directLink($params, $content = "")
    {
        ...
        $target = isset($params['target'])?"target='".wpdm_sanitize_var($params['eid'], 'txt')."'":"";
        $class = isset($params['class'])?"class='".wpdm_sanitize_var($params['eid'], 'txt')."'":"";
        ...
        return  "<a {$target} {$class} {$eid} href='$linkURL'>$linkLabel</a>";
